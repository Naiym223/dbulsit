...
module.exports.run = async (client, message, args) => {
  ...
  if (!bot) {
      ...
      .setDescription(`<:deny:921193390614384650> *You have given an invalid bot ID or mention.*\n<:approve:921193380288016444> **Ex.** *;votebot @bot or 123456789123456789*`)
       .setColor("#7289da")
  ...
  var seconds = timeleft.seconds;
    ...
    client.channels.cache.get("921202001562456084").send(`**${botdata.username}** just got **+1 Vote** from **${message.author.username}** **\`(Total Votes ${botdata.votes + 1})\`**`)
    let web = new MessageButton()
      .setLabel("Visit bot page")
      .setStyle("url")
      .setURL("https://dbulist.xyz/bot/"+botdata.botID)
